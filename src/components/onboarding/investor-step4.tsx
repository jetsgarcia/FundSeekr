...
import { uploadFile, finalizeInvestorOnboarding } from "@/actions/onboarding";

interface InvestorStep4Props {
...
export default function InvestorStep4({ setStep }: InvestorStep4Props) {
  ...
  const isValid = () => {
    // Check that all required files are uploaded successfully
    const requiredFiles: (keyof DocumentFiles)[] = [
      "validId",
      "proofOfBank",
      "selfie",
    ];
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      const documentUrls = {
        ...
        proofOfBankUrl: uploadStates.proofOfBank.url!,
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-6">
            ...
            must be clear, readable, and in PDF or image format (max 4MB each).
          </p>
              ...
              <div className="relative">
                ...
                <label
                  ...
                  className={`flex items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${
                    ...
                    uploadStates.selfie.isUploading ? "cursor-not-allowed" : ""
                  }`}
                >
                  <div className="text-center">
                    {uploadStates.selfie.isUploading ? (
